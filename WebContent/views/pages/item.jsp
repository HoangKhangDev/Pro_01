                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="content">
                                <div class="top-content">
                                    <a href="javascript:void(0)" class="tag">${itemname }</a>
                                    <h3 class="title">
                                        <a href="item-details.html">Title Video</a>
                                    </h3>
                                ...
                                <div class="bottom-content d-flex justify-content-around p-3 m-0">
                                    <p class="d-flex align-items-center price"><i class="lni lni-share like"></i> SHARE</p>
                                    <p class="d-flex align-items-center price">LIKE<i class="lni lni-heart like"></i></a>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Grid -->
